...
require '../inc/connection.php'; // Use require instead of @include
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="d-flex justify-content-end mb-3">
            <?php if ($has_active_filters): ?>
                <a href="myProperties.php?status=<?= $status_filter ?>" class="btn btn-outline-danger">Clear Filters</a>
            <?php endif; ?>
        </div>
        <div class="d-flex justify-content-end mb-3">
            <div>
        ...
        <div class="container mb-5">
            ...
            <?php } else { ?>
                <h1 class="heading text-center mb-4">My Property List</h1> <!-- Centered Title -->
                <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            <a href="property_details.php?id=<?= $row['property_id'] ?>" class="text-decoration-none">
                                <div class="property-card border rounded shadow-sm">
                                    ...
                                    <div class="p-3 text-center"> <!-- Centered Text -->
