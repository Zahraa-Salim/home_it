...
<body>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-fluid nav-bar bg-transparent">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="addProperty.php" class="btn btn-primary px-3 d-none d-lg-fle">Add Property</a>
                </div>
            </nav>
        </div>
        <!-- Navbar End -->
        ...
        <div class="container"><br><br>
            <?php if (mysqli_num_rows($my_properties) == 0) { // Check if the result set is empty ?>
                <h1 class="heading"><center>You didn’t upload any property yet</center></h1>
                <div class="property-image">
                    <img src="../img/no_property.jpg" alt="No Property" class="no-property-image">
                </div>
            <?php } else { ?> <!-- Corrected the placement of else -->
                <h1 class="heading"><center>My Property List</center></h1>
                    ...
                    <?php while ($row = mysqli_fetch_assoc($my_properties)): ?>
                        ...
                        <a href="property_details.php?id=<?= $row['property_id'] ?>">
                            <div class="property-card">
                                <div class="property-image">
                                    <img src="<?=$row['main_image'] ?: '../img/z-image1.webp'?>" alt="Property">
                                    <span class="for-rent"><?=$row['purpose']?></span>
                                </div>
